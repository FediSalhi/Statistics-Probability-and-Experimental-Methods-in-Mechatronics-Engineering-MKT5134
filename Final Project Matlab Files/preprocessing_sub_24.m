...
% load occular artifact-free eeg data (subject 24)
...
figure(2),
subplot(1,2,1),
boxplot([right_hand_eeg(1:163890,1), left_hand_eeg(1:163890,1), mental_arithmetic_eeg(1:163890,1), rest_eeg(1:163890,1)], 'Labels', {'Right hand MI', 'Left hand MI', 'MA', 'Rest state'})
...
subplot(1,2,2),
boxplot([right_hand_eeg_no_outliers(1:102608,1), left_hand_eeg_no_outliers(1:102608,1), mental_arithmetic_eeg_no_outliers(1:102608,1), rest_eeg_no_outliers(1:102608,1)], 'Labels', {'Right hand MI', 'Left hand MI', 'MA', 'Rest state'})
