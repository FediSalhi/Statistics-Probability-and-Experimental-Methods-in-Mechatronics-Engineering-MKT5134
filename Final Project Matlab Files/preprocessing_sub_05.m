...
% load occular artifact-free eeg data (subject 05)
...
subplot(1,2,2),
boxplot([right_hand_eeg_no_outliers(1:80122,1), left_hand_eeg_no_outliers(1:80122,1), mental_arithmetic_eeg_no_outliers(1:80122,1), rest_eeg_no_outliers(1:80122,1)], 'Labels', {'Right hand MI', 'Left hand MI', 'MA', 'Rest state'})
