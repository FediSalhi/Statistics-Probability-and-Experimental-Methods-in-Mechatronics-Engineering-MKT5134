...
%% parameters
subdir_list = {'subject 21', 'subject 22', 'subject 23', 'subject 24', 'subject 25'}; % subject
...
% load occular artifact-free eeg data (subject 25)
...
loadDir = fullfile(EegMyDataDir, subdir_list{5});
cd(loadDir);
...
figure(2),
subplot(1,2,1),
boxplot([right_hand_eeg(1:163645,1), left_hand_eeg(1:163645,1), mental_arithmetic_eeg(1:163645,1), rest_eeg(1:163645,1)], 'Labels', {'Right hand MI', 'Left hand MI', 'MA', 'Rest state'})
