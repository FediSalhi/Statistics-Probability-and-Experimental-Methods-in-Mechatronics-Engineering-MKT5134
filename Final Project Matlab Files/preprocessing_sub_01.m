...
%% parameters
subdir_list = {'subject 01', 'subject 02', 'subject 03', 'subject 04', 'subject 05'}; % subject
...
% load occular artifact-free eeg data (subject 01)
WorkingDir = 'C:\Users\Designer\Desktop\Master''s Deg\Spring 2019 - 2020\Mekatronik Mühendisliðinde Ýstatistik Olasýlýk ve Deneysel Yöntemler\Project\Project\Matlab codes';
...
title('Right Hand Motor Imagery' , 'fontsize', 11),
xlabel('Channel 1 - Voltage (mV)', 'fontsize', 11)
ylabel('Freqeuncy', 'fontsize', 11);

subplot(2,2,2)
histogram(left_hand_eeg(:,1)),
title('Left Hand Motor Imagery', 'fontsize', 11),
xlabel('Channel 1 - Voltage (mV)', 'fontsize', 11)
ylabel('Freqeuncy', 'fontsize', 11);

subplot(2,2,3)
histogram(mental_arithmetic_eeg(:,1)),
title('Mental Arithmetic ', 'fontsize', 11),
xlabel('Channel 1 - Voltage (mV)', 'fontsize', 11)
ylabel('Freqeuncy', 'fontsize', 11);

subplot(2,2,4)
histogram(rest_eeg(:,1)),
title('Rest State', 'fontsize', 11),
xlabel('Channel 1 - Voltage (mV)', 'fontsize', 11)
ylabel('Freqeuncy', 'fontsize', 11);
...
title('Before removing outliers', 'fontsize', 11)
xlabel('Event', 'fontsize', 11)
%ylim([-350 250
ylabel('Channel-1 volatage (mV)', 'fontsize', 11)

subplot(1,2,2),
boxplot([right_hand_eeg_no_outliers(1:116800,1), left_hand_eeg_no_outliers(1:116800,1), mental_arithmetic_eeg_no_outliers(1:116800,1), rest_eeg_no_outliers(1:116800,1)], 'Labels', {'Right hand MI', 'Left hand MI', 'MA', 'Rest state'})
title('After removing outliers', 'fontsize', 11)
xlabel('Event', 'fontsize', 11)
ylabel('Channel-1 volatage (mV)', 'fontsize', 11)
