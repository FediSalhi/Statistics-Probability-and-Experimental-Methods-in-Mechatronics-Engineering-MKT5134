...
%% parameters
subdir_list = {'subject 06', 'subject 07', 'subject 08', 'subject 09', 'subject 10'}; % subject
...
% load occular artifact-free eeg data (subject 08)
...
loadDir = fullfile(EegMyDataDir, subdir_list{3});
cd(loadDir);
...
figure(2),
subplot(1,2,1),
boxplot([right_hand_eeg(1:164274,1), left_hand_eeg(1:164274,1), mental_arithmetic_eeg(1:164274,1), rest_eeg(1:164274,1)], 'Labels', {'Right hand MI', 'Left hand MI', 'MA', 'Rest state'})
...
subplot(1,2,2),
boxplot([right_hand_eeg_no_outliers(1:105012,1), left_hand_eeg_no_outliers(1:105012,1), mental_arithmetic_eeg_no_outliers(1:105012,1), rest_eeg_no_outliers(1:105012,1)], 'Labels', {'Right hand MI', 'Left hand MI', 'MA', 'Rest state'})
