...
%% parameters
subdir_list = {'subject 11', 'subject 12', 'subject 13', 'subject 14', 'subject 15'}; % subject
...
% load occular artifact-free eeg data (subject 12)
...
loadDir = fullfile(EegMyDataDir, subdir_list{2});
cd(loadDir);
...
subplot(1,2,2),
boxplot([right_hand_eeg_no_outliers(1:108745,1), left_hand_eeg_no_outliers(1:108745,1), mental_arithmetic_eeg_no_outliers(1:108745,1), rest_eeg_no_outliers(1:108745,1)], 'Labels', {'Right hand MI', 'Left hand MI', 'MA', 'Rest state'})
