...
% load occular artifact-free eeg data (subject 03)
...
figure(2),
subplot(1,2,1),
boxplot([right_hand_eeg(1:109271,1), left_hand_eeg(1:109271,1), mental_arithmetic_eeg(1:109271,1), rest_eeg(1:109271,1)], 'Labels', {'Right hand MI', 'Left hand MI', 'MA', 'Rest state'})
...
subplot(1,2,2),
boxplot([right_hand_eeg_no_outliers(1:98019,1), left_hand_eeg_no_outliers(1:98019,1), mental_arithmetic_eeg_no_outliers(1:98019,1), rest_eeg_no_outliers(1:98019,1)], 'Labels', {'Right hand MI', 'Left hand MI', 'MA', 'Rest state'})
